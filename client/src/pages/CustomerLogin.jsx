    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .cl-logo-icon { width: 40px; height: 40px; background: var(--brand); border-radius: 10px; display: flex; align-items: center; justify-content: center; font-size: 18px; }
        ...
        .cl-input:focus { border-color: var(--brand); }
        ...
        .cl-btn { width: 100%; padding: 14px; background: var(--brand); color: #fff; border: none; border-radius: 10px; font-size: 14px; font-weight: 600; cursor: pointer; transition: opacity 0.2s; margin-top: 8px; }
        ...
        .cl-foot a { color: var(--brand); text-decoration: none; }
        .cl-back { display: block; text-align: center; margin-top: 16px; font-size: 13px; color: rgba(240,244,255,0.2); text-decoration: none; }
        .cl-back:hover { color: var(--brand); }
        .cl-from-banner { display: flex; align-items: center; gap: 10px; background: rgba(249,115,22,0.08); border: 1px solid rgba(249,115,22,0.2); border-radius: 10px; padding: 12px 14px; margin-bottom: 24px; font-size: 13px; color: rgba(240,244,255,0.6); }
      `}</style>
      ...
      <div className="cl-root">
        <div className="cl-card">
          <a href="/" className="cl-logo">
            ...
            <div className="cl-logo-text">{bizName}</div>
          </a>

          {new URLSearchParams(window.location.search).get('from') === '/book' && (
            <div className="cl-from-banner">
            ...
            <div className="cl-field">
              ...
              <div style={{ position:'relative' }}>
                ...
                <button
                  ...
                  style={{ position:'absolute', right:14, top:'50%', transform:'translateY(-50%)', background:'none', border:'none', cursor:'pointer', color:'rgba(240,244,255,0.35)', fontSize:16, padding:0 }}
                >
                  {showPass ? '🙈' : '👁️'}
                </button>
              </div>
          ...
          <div className="cl-foot">
            ...
            <Link to={`/register${window.location.search}`}>Create one free</Link>
          </div>
