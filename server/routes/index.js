...
import { createTenant, getAllTenants, getTenantBySubdomain, updateTenant, updateTenantStatus, deleteTenant, loginTenantAdmin, getTenantMe, updateTenantMe } from '../controllers/tenantController.js'
...
router.post('/riders', protectTenant, createRider)
